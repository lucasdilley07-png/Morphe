...
3. Fill the listing from `AppStore/metadata.md`; set Privacy Policy URL from step 1; App Privacy → declare the collected data per `AppStore/metadata.md` (NOT "Data Not Collected").
